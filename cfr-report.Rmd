...
We assumed that the observed number of Covid-19 deaths ($D$) within 28 days by date of infection were a function of Covid-19 notifications ($C$) by date of infection scaled by the case fatality rate of S-gene positive cases ($c^+$) and S-gene negative cases ($c^-$), 
