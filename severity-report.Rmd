...
where $\alpha$ represents either the multiplicative change in case fatality rate or the additive change. These alternative parametrisations represent either a population wide effect for the former parametrisation or a subpopulation effect in the latter parametrisation.
