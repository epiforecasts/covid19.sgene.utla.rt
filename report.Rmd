...
where $R^-_{t, i}$ is the S-gene negative reproduction number of $R^+_{t, i}$ is the S-gene positive reproduction number and it assumed that $R^-_{t, i} = (1 + \alpha) R^+_{t, i}$
