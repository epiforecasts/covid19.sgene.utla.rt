...
The best fitting model appeared to reproduce estimated reproduction numbers well over time (Figure 2), although there are notable outliers in some of the weeks. Alternative model parametrisations fit the data less well than those presented here whilst producing comparable effect size estimates.
